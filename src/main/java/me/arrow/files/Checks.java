...
public class Checks implements Initializer {
    ...
    public enum Setting {
        ...
        INTERACT_E("InteractE.enabled", true, "Should we enable this module?"),
        INTERACT_E_PUNISH("InteractE.punish", "", "Punishment settings"),
        INTERACT_E_PUNISH_ENABLED("InteractE.punish.enabled", true, "Should punishments be enabled for this check?"),
        ...
        INVENTORY_A_MAX_VL("InventoryA.punish.vl", 10, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        SCAFFOLD_D("ScaffoldD.enabled", true, "Should we enable this module?"),
        SCAFFOLD_D_PUNISH("ScaffoldD.punish", "", "Punishment settings"),
        SCAFFOLD_D_PUNISH_ENABLED("ScaffoldD.punish.enabled", true, "Should punishments be enabled for this check?"),
        ...
        GROUND_A_MODE("GroundA.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        GROUND_B_MODE("GroundB.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        GROUND_B_MAX_VL("GroundB.punish.vl", 15, "The maximum violation amount a player needs to reach in order to get punished"),
        ...
        GRAVITY_B_MODE("GravityB.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        GRAVITY_C_MODE("GravityC.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        GRAVITY_D_MODE("GravityD.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        MOTION_A_MODE("MotionA.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        MOTION_B_MODE("MotionB.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        MOTION_C_MODE("MotionC.mode", CheckMode.MITIGATE.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        MOTION_D_MODE("MotionD.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        MOTION_E_MODE("MotionE.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        ILLEGALMOVE_A_MODE("IllegalMoveA.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
        ...
        ILLEGALMOVE_B_MODE("IllegalMoveB.mode", CheckMode.BOTH.getCheckMode(), "Choose whether to flag, mitigate or do both (Must type all caps either FLAG, MITIGATE or BOTH)"),
