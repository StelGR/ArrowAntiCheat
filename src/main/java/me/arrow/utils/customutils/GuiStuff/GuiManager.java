    ...
    public void openPlayerInfoGUI(Player player, Player playerForInfo) {
        ...
        Runnable refresh = () -> {
            ...
            updateLore.accept(13, Arrays.asList(
                    ...
                    "",
                    translate("&7Client PPS: " + MsgType.MAIN_THEME_COLOR.getMessage() + info.getClientPPS()),
                    translate("&7Server PPS: " + MsgType.MAIN_THEME_COLOR.getMessage() + info.getServerPPS()),
                    "",
