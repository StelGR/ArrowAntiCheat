...
import me.arrow.core.event.CoreEventProcessor;
...
public class GeneralEventListener implements Listener {
    ...
    private final CoreEventProcessor coreEvents = new CoreEventProcessor();
    ...
    public void onChunkUnload(ChunkUnloadEvent event) {
        Chunk chunk = event.getChunk();
        ChunkCache.get().removeChunk(chunk.getWorld().getName(), chunk.getX(), chunk.getZ());
    }
    ...
    void process(Event event) {
                ...
                public void run() {
                    ...
                    for (Player receiver : PlatformBackend.get().getServer().getOnlinePlayers()) {
                        ...
                        TaskUtils.player(receiver, () -> {
                            ...
                            coreEvents.trackEachOther(joiningProfile, otherProfile);
                        });
                    }
        ...
        if (event instanceof PlayerQuitEvent) {
            ...
            if (quittingProfile != null) {
                coreEvents.clearTrackedEntities(quittingProfile);
            ...
            for (Player online : PlatformBackend.get().getServer().getOnlinePlayers()) {
                ...
                coreEvents.playerLeft(quitting.getUniqueId(), quitting.getEntityId(), otherProfile);
            }
        ...
        if (event instanceof PlayerRespawnEvent) {
            ...
            if (user != null) {
                coreEvents.playerRespawned(user);
            }
        }
        ...
        if (event instanceof InventoryOpenEvent) {
            ...
            if (user != null) {
                coreEvents.setInventoryOpen(user, true);
            }
        }
        if (event instanceof InventoryCloseEvent) {
            ...
            if (user != null) {
                coreEvents.setInventoryOpen(user, false);
            }
        }
    }
